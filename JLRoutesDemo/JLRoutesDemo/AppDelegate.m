...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //执行route操作
    [self performSelector:@selector(appDelegateHandler) withObject:nil afterDelay:4];
    
    return YES;
}


-(void)appDelegateHandler
{
    NSString *customURL = @"JLRoutesDemo://Service/ServiceMediator?userId=99999&age=18";
